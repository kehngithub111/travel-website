...
const Footer = () => {
    return (
        <footer className="bg-[#8dd3bb] relative px-4 mt-[10rem] py-10 max-sm:py-7">
            <div className='flex flex-col max-w-[1500px] w-full mx-auto'>
                <div className="flex justify-between pb-10 border-b border-[#112211] max-sm:pb-5">
                    <div className="flex flex-col justify-between w-1/2 max-md:w-full max-md:items-center">
                        ...
                        <div className="max-md:flex max-md:flex-col max-md:items-center">
                            ...
                            <p className='max-md:text-center max-md:text-sm'>Get inspired! Receive travel discounts, tips and behind the scenes stories.</p>

                            <div className="flex w-full mt-3 gap-4 max-sm:gap-2">
                                <input type="text" className="h-[50px] flex-1 px-4 rounded-md outline-none max-sm:h-[40px] max-sm:text-sm" placeholder="Your email address" />
                                <button className="h-[50px] bg-[#112211] w-[150px] text-[#ffffff] rounded-md max-sm:h-[40px] max-sm:text-sm max-sm:w-[120px]">Subscribe</button>
                            </div>
                        </div>
                    </div>
