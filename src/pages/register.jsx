        ...
        <div className='w-1/2 p-[4rem] flex items-center justify-center relative max-[768px]:w-full max-sm:px-[1rem] max-sm:py-[1.5rem]'>
          <form className='max-w-[600px] w-full mx-auto h-full'>
            ...
            <div className='flex flex-col gap-4 max-sm:gap-1'>
              <h1 className='text-4xl font-medium max-sm:text-2xl'>Sign Up</h1>
              <p className='text-sm text-gray-500'>Let’s get you all st up so you can access your personal account.</p>
            </div>
            ...
            <div className='flex items-center gap-2'>
              ...
              <label htmlFor="" className='text-sm'>I agree to all the <span className='text-red-500'>Terms</span> and <span className='text-red-500'>Private Policies</span></label>
            </div>
            ...
            <div className='flex items-center gap-2 justify-center my-[1rem]'>
              ...
              <NavLink to="/login" className="text-red-500 text-sm">Login</NavLink>
            </div>
